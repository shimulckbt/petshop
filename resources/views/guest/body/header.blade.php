         ...
         <div class="row">
            <div class="col-lg-12 text-center text-lg-right">
               <ul class="menu list-inline mb-0">
                  ...
                  @else
                  <li class="list-inline-item"><a href="{{ route('dashboard') }}">{{ Auth::user()->first_name." ".Auth::user()->last_name }}</a></li>
                  <li class="list-inline-item"><button class="btn btn-primary" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Logout</button>
   ...
   <nav class="navbar navbar-expand-lg">
      <div class="container">
         <a href="{{route('welcome')}}" class="navbar-brand home">
            <img class="rounded-circle" width="80" height="80" src="{{asset('guest/img/petshop.jpg')}}" alt="Obaju logo" class="d-none d-md-inline-block">
                  ...
                  <ul class="dropdown-menu megamenu">
                     <li>
                        <div class="row">
                           ...
                           <div class="col-md-6 col-lg-3">
                              <div class="banner"><a href="#"><img src="{{asset('guest/img/banner.jpg')}}" alt="" class="img img-fluid"></a></div>
                              <div class="banner"><a href="#"><img src="{{asset('guest/img/banner2.jpg')}}" alt="" class="img img-fluid"></a></div>
                           </div>
                        </div>
                     </li>
                  </ul>
