                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="mb-0 mt-2">
                                    <a class="btn btn-sm btn-primary" href="{{ route('subCategory.create') }}">&#8678; Go
                                        Back</a>
                                </div>
                                <div class="row">
                                    <div class="col-8 mb-4">
                                        <div class="h5 mb-0 mt-4 font-weight-bold text-gray-800">
                                            ...
                                            <form id="addProduct"
                                                action="{{ route('subCategory.update', $productSubCategory) }}"
                                                method="POST">
                                                @csrf
                                                <div class="form-group">
                                                    <label for="exampleProductName">Category Name</label>
