                     ...
                     <table class="table table-bordered dataTable" id="dataTable" role="grid" aria-describedby="dataTable_info" style="width: 100%;" width="100%" cellspacing="0">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td class="text-center">{{isset($seller->sellerDetail->skill_type)?$seller->sellerDetail->skill_type:'Null'}}</td>
                              <td class="text-center">{{isset($seller->sellerDetail->ownership_type)?$seller->sellerDetail->ownership_type:'Null'}}</td>
                              <td class="text-center">{{isset($seller->sellerDetail->working_experience)?$seller->sellerDetail->working_experience:'Null'}} Years</td>
                              <td class="text-center">{{isset($seller->sellerDetail->phone_number)?$seller->sellerDetail->phone_number:'Null'}}</td>
