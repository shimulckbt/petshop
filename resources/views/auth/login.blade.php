                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select id="role_id" type="text" class="form-control @error('role_id') is-invalid @enderror" name="role_id" value="{{ old('role_id') }}" required autocomplete="role_id" autofocus>
                                    <option selected value="" disabled>Register As:</option>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="box">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                <label for="email">Email</label>
                                <input id="email" type="email" name="email" class="form-control @error('email') is-invalid @enderror" class="form-control" value="{{ old('email') }}" required autocomplete="email" autofocus>
                                @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
